...
const char* SDL_IOS_GetResourceDir()
{
    if (!resource_dir)
    {
        ...
        resource_dir = (const char *)malloc(strlen(temp) + 1);
        memcpy((void *)&resource_dir[0],(void *)&temp[0],strlen(temp)+1);
    }
...
const char* SDL_IOS_GetDocumentsDir()
{
    if (!documents_dir)
    {
        ...
        documents_dir = (const char *)malloc(strlen(temp) + 1);
        memcpy((void *)&documents_dir[0],(void *)&temp[0],strlen(temp)+1);
    }
